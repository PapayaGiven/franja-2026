...
/**
 * Conferencistas — lista completa de ponentes. Featured primero,
 * después alfabético (orden que devuelve listSpeakers). Avatar gris
 * cuando photo_url es null.
 */
        ...
        <ul className="grid grid-cols-1 gap-2">
          {speakers.map((s) => (
            <li key={s.id}>
              ...
              >
                <SpeakerAvatar photoUrl={s.photo_url} name={s.full_name} size={44} />
                ...
                {s.is_featured && (
                  <span className="ml-auto text-[10px] font-semibold uppercase tracking-widest text-franja-gold shrink-0">
                    Destacado
                  </span>
                )}
              </Link>
